package com.example.pet.kakaologin.service;

import com.example.pet.kakaologin.dto.KakaoInfo;
import com.example.pet.kakaologin.dto.KakaoToken;
import com.example.pet.kakaologin.client.KakaoClient;
...
public class KakaoService {
    ...
    public KakaoInfo getInfo(final String code) {
        ...
        try {
            return client.getInfo(new URI(kakaoUserApiUrl), token.getTokenType() + " " +
